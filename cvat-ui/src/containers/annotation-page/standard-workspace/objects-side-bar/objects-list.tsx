...
const componentShortcuts = {
    ...
    DELETE_OBJECT_STANDARD_WORKSPACE: {
        name: '删除对象',
        description: '删除活动对象。使用Shift强制删除锁定的对象',
        sequences: ['del', 'shift+del'],
        scope: ShortcutScope.STANDARD_WORKSPACE,
    },
    TO_BACKGROUND: {
        name: '置于底层',
        description: '将活动对象放得离用户更"远"（减小Z轴值）',
        sequences: ['-', '_'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    TO_FOREGROUND: {
        name: '置于顶层',
        description: '将活动对象放得离用户更"近"（增大Z轴值）',
        sequences: ['+', '='],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    COPY_SHAPE: {
        name: '复制形状',
        description: '将形状复制到CVAT内部剪贴板',
        sequences: ['ctrl+c'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
