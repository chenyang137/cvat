...
export default function CreateCloudStorageForm(props: Props): JSX.Element {
            ...
            return (
                <>
                    <Form.Item
                        label='访问密钥 ID'
                        name='key'
                        rules={[{ required: true, message: '请输入访问密钥 ID' }]}
                        {...internalCommonProps}
                    >
                        <Input.Password
                            maxLength={128}
            ...
            return (
                <>
                    ...
                    <Form.Item
                        label='SAS 令牌'
                        name='SAS_token'
                        rules={[{ required: true, message: '请输入 SAS 令牌' }]}
                        {...internalCommonProps}
                    >
                        <Input.Password
    ...
    return (
        ...
        >
            ...
            <Form.Item {...commonProps} label='描述' name='描述'>
            ...
            <Form.Item
                ...
                label='服务商'
                name='provider_type'
                rules={[{ required: true, message: '请选择云存储服务商' }]}
            >
                <Select
