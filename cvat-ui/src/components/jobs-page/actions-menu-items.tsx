...
export default function JobActionsItems(
    ...
    menuItems.push([{
        key: 'task',
        label: withCount('转到任务', 'task', `/tasks/${taskId}`),
    ...
    if (projectId) {
        menuItems.push([{
            key: 'project',
            label: withCount('转到项目', 'project', `/projects/${projectId}`),
    ...
    if (onOpenBugTracker) {
        menuItems.push([{
            ...
            label: withCount('转到错误跟踪器', 'bug_tracker'),
    ...
    menuItems.push([{
        ...
        label: withCount('导入注释', 'import_job'),
    ...
    menuItems.push([{
        ...
        label: withCount('导出注释', 'export_job'),
