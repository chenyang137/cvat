...
function LockAllSwitcher(props: Props): JSX.Element {
    ...
    return (
        <Col span={3}>
            <CVATTooltip title={`为所有对象切换锁定属性 ${switchLockAllShortcut}`}>
...
function HideAllSwitcher(props: Props): JSX.Element {
    ...
    return (
        <Col span={3}>
            <CVATTooltip title={`为所有对象切换隐藏属性 ${switchHiddenAllShortcut}`}>
                {statesHidden ? (
